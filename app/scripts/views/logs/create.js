define([
  ...
  ], function(Backbone, Marionette, DailyLog, logFormTemplate, mealRowTemplate, exerciseRowTemplate) {
  return Marionette.ItemView.extend({
    template: logFormTemplate,

    initialize: function(options) {
      this.dailyLogs = options.logsCollection;
